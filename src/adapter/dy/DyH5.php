 ...
 */
class DyH5 extends BaseAdapter
{
    protected string $platform = 'dy';
    protected string $channel = 'h5';

    protected string $baseUrl = 'https://m.douyin.com';
    ...
    {
        // TODO: H5 页面 Cookie 验证，通常需要额外处理 wap_sid 等参数
    ...
    {
        // TODO: 抖音 H5 用户信息接口
        // 接口示例：GET https://m.douyin.com/share/user/{uid}
        return [false, [], 'TODO: 待实现'];
    }
